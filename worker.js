    ...
    if (url.pathname === '/proxy') {
      ...
      try {
        ...
        if (contentType.includes('text/html')) {
          ...
          html = html.replace(
            /(href|src|data-src|srcset)="(\/{2,})/g,
            `$1="https://${baseUrl}$2`
          );
          html = html.replace(
            /(href|src|data-src|srcset)="(https?:\/\/[^"]+)"/g,
        ...
        // Handle images, styles, and other binary content
        ...
        // Pass through other content types like CSS or JavaScript
        return new Response(response.body, {
...
<body>
  ...
  <script>
    function loadUrl() {
      ...
      // Optionally clear input field after submitting
